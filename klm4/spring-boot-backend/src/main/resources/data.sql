...
VALUES (500, 'C3' , current_time, 'BOEING737700', 'PH_AKA', 'Nitrogen Cart', 0, 'Left', 'Pending', null, current_time, current_time , current_time, current_time, 1001);
...
VALUES (501, 'B5', current_time, 'BOEING737700', 'PH_AKA', 'Nitrogen Cart', 0, 'Left', 'Delivered', null, current_time, current_time, current_time, current_time , 1002);
INSERT INTO REQUEST(id, location, deadline, plane_type, tail_type, wagon_type, selected_wagon, position, status, extra_info, request_created, completion_time, delivery_time, request_updated, user_id)
VALUES (502, 'B5', current_time, 'BOEING737700', 'PH_AKA', 'Skydrolwagen', 0, 'Left', 'Pending', null, current_time, current_time, current_time, current_time , 1001);
INSERT INTO REQUEST(id, location, deadline, plane_type, tail_type, wagon_type, selected_wagon, position, status, extra_info, request_created, completion_time, delivery_time, request_updated, user_id)
VALUES (503, 'F7', current_time, 'BOEING737700', 'PH_AKA', 'Tires Cart', 0, 'Left', 'Pending', 'N:2, M:1', current_time, current_time, current_time, current_time , 1002);
INSERT INTO REQUEST(id, location, deadline, plane_type, tail_type, wagon_type, selected_wagon, position, status, extra_info, request_created, completion_time, delivery_time, request_updated, user_id)
VALUES (504, 'F7', current_time, 'BOEING737700', 'PH_AKA', 'Nitrogen Cart', 0, 'Left', 'Delivered', null, current_time, current_time, current_time, current_time , 1001);
